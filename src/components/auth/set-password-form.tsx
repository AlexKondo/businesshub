...
// Reached by clicking an admin-sent invite link (see /api/tenants/invite-supplier):
// the invite code exchange in /auth/callback already established a session
// and created the Fornecedor membership, but never asked the invitee to
// choose a password — they'd otherwise have no way to log back in except
// requesting another invite. This is that missing step, on the tenant's own
// subdomain since the session (and membership) is already tenant-scoped.
